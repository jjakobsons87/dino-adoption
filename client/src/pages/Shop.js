...
const Shop = (props) => {
    return (
        ...
        <p className="text-darkgrey text-center">Style your dinosaur in both a cute and safe way. Harness and Muzzle HIGHLY recommended to avoid any... unpleasant situations, especially for Carnivores!</p>
            <div>
